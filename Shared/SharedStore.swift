...
public enum SharedStore {
    ...
    public static let appGroupID = "group.com.boopeshkumar.expmgr"
    ...
    /// `expmgr://` URL instead of writing them itself. See TransactionLink.
    ...
    public static func storeURL() throws -> URL {
        if let shared = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: appGroupID) {
            return shared.appending(path: "ExpMgr.store")
        }
        ...
        return support.appending(path: "ExpMgr.store")
    }
    ...
    public static func makeContainer() throws -> ModelContainer {
        let configuration = ModelConfiguration(
            ...
            //     cloudKitDatabase: .private("iCloud.com.boopeshkumar.expmgr")
